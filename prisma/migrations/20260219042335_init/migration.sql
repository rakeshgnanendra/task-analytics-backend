-- CreateEnum
CREATE TYPE "GlobalRole" AS ENUM ('DELIVERY_HEAD', 'USER');

-- CreateEnum
CREATE TYPE "ProjectRole" AS ENUM ('PROJECT_MANAGER', 'TEAM_MEMBER');

-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('CREATED', 'IN_PROGRESS', 'COMPLETED', 'CONFIRMED', 'REJECTED');
...
-- CreateEnum
CREATE TYPE "ActionType" AS ENUM ('TASK_CREATED', 'STATUS_CHANGED', 'TASK_CONFIRMED', 'TASK_REJECTED');
